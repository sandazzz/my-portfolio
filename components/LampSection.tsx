...
import { Github, Linkedin, Mail, FolderGit2 } from "lucide-react";
          ...
          <div className="flex max-w-full flex-wrap gap-2">
            ...
            <a href="#projects">
              <Button
                variant="outline"
                size="sm"
                className="text-gray-900 dark:text-white border-gray-300 dark:border-white hover:bg-red-300 hover:text-white dark:hover:bg-white dark:hover:text-black"
              >
